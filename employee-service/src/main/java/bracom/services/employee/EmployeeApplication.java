package bracom.services.employee;
...
import bracom.services.employee.model.Employee;
import bracom.services.employee.repository.EmployeeRepository;
...
public class EmployeeApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("bracom.services.employee.controller"))
